  ...
  return (
    <div>
      ...
      <div className="warning-banner">
        ...
        và D (tick khi đăng xong). Cần cấu hình Google Sheet ID +
        file khoá Service Account trong Cài đặt trước khi đồng bộ. Video Google Drive phải được
        chia sẻ cho email Service Account (hoặc bật "Anyone with the link").
      </div>
